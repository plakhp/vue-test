  ...
  <div class="app-container">
    ...
    <div class="filter-left">
      ...
      <div class="order_price">
        <span>订单金额:</span>
        <el-input v-model.number="filter.minPrice" placeholder="最小金额" @blur="inputNumber" />-
        <el-input v-model.number="filter.maxPrice" placeholder="最大金额" @blur="inputNumber" />
      </div>
      <div>
        <span>下单用户:</span>
...
export default {
  ...
  methods: {
    ...
    search() {
      var flag1 = this.check(this.filter.minPrice)
      var flag2 = this.check(this.filter.maxPrice)
